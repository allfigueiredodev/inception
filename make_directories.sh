...
echo "DOMAIN_NAME=aperis-p.42.fr" > project/srcs/.env
echo "CERT_=./requirements/tools/aperis-p.42.fr.crt" >> project/srcs/.env
echo "KEY_=./requirements/tools/aperis-p.42.fr.key" >> project/srcs/.env
